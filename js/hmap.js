  ...
  function(error, data) {
    ...
    cards.enter().append("rect")
        ...
        d3.select(this).transition()
            ...
            .attr("x", function(d) { return built(d.built) * gridSize -5; })
            .attr("y", function(d) { return sold(d.sold) * gridSize -5; })
          })
    ...
    svg.append('text').text('Sales Count').attr('x', 10).attr('y', height-5);
